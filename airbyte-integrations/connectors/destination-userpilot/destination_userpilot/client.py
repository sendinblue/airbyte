...
class UserpilotClient:
    ...
    def _get_base_url(self) -> str:
        return f"https://analytex-eu.userpilot.io/v1/{self.endpoint}"
    ...
    def _request(self, data: List[Mapping] = None, http_method: str = "POST") -> requests.Response:
        ...
        if self.endpoint == "identify":
            ...
            if data.get("metadata"):
                validated_data["metadata"] = {
                    key: "None" if value is None else str(value) if isinstance(value, bool) else value
